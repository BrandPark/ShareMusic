...
public class CollectionController {
	...
	@PostMapping("/")
	public ResponseEntity<String> insertCollection(@RequestBody CollectionDTO collectionDTO) {
	...
	(@PathVariable("userId") String userId) throws UserException, CollectionException {
	...
	// 사용자의 특정 컬렉션들 조회
	@GetMapping("/cno/{cno}")
	public ResponseEntity<CollectionDTO> getCollection(@PathVariable("cno") int cno) throws CollectionException {
		CollectionDTO collectionDTO = getCollectionDTOByCno(cno);
	...
	public ResponseEntity<List<CollectionDTO>> getRecentCollectionsWithFollower(@PathVariable("userId") String userId) throws CollectionException {
